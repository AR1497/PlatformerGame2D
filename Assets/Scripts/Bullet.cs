...
public class Bullet
{
    ...
    public void Update()
    {
        if (IsGrounded())
        {
            ...
            _bulletView.transform.position = _bulletView.transform.position.Change(y: _bulletView.GroundLevel - _bulletView.DetectionRadius);
        }
        else
        {
    ...
    {
        return _bulletView.transform.position.y <= _bulletView.GroundLevel - _bulletView.DetectionRadius && _velocity.y <= 0;
    }
}
